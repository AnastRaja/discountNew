                     ...
                     <div className='row'>
                           <div className='col-lg-7'>
                                ...
                                <div className='for_new_po'>
                                    ...
                                    <label>Enter Token <span>Address</span>: <i class="fas fa-question-circle"></i></label>
                                        ...
                                        <div className='form-group mb-4'>
                                    <label>Enter Token <span> Name</span>: <i class="fas fa-question-circle"></i></label>
                                        <div className=' input_flex_clas'>
                                        ...
                                        <div className='form-group mb-4'>
                                    <label>Enter Token<span>Symbol</span>: <i class="fas fa-question-circle"></i></label>
                                        <div className=' input_flex_clas'>
                                        ...
                                        <div className='form-group mb-4'>
                                    <label>Enter Token<span>Decimal</span>: <i class="fas fa-question-circle"></i></label>
                                        <div className=' input_flex_clas'>
                                        <input placeholder='Exampe: 1' /> 
                                   
                                        </div>
                                        </div>
                                        <div className='form-group mb-4'>
                                    <label>Enter Token<span>Supply</span>: <i class="fas fa-question-circle"></i></label>
                                        <div className=' input_flex_clas'>
                                        <input placeholder='Exampe: 1000' /> 
                                   
                                        </div>
                                        </div>
                                        <div className='form-group mb-4'>
                                    <label>Numbers of Tokens to offer in<span>Discount</span>: <i class="fas fa-question-circle"></i></label>
                                        <div className=' input_flex_clas'>
                                        <input placeholder='Exampe: 10000' /> 
